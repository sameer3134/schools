...
const About = () => {
  return (
    <div>
         ...
         <div className="columns image" style={{backgroundImage:"url('/images/100.jpg')"}}>
            &nbsp;
         </div>
        ...
        developing in them a strong character, love of truth, respect loyalty a sense of justice and the necessity for honest, hard work. This will make them an honour for womanhood and a source of happiness and blessing to all with whom they come in contact.
